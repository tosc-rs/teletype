...
use embedded_graphics::{prelude::{Dimensions, Point, Size, DrawTarget, IntoStorage, RgbColor}, primitives::Rectangle, Pixel, pixelcolor::Rgb888, mono_font::MonoTextStyle};
...
fn main() {
    ...
    let style = ring_drawer::BwStyle {
        ...
        font: MonoTextStyle::new(&PROFONT_12_POINT, Rgb888::WHITE),
    };
    ...
    loop {
        ...
        ring_drawer::drawer_bw(&mut disp, &rline, style.clone()).unwrap();
        window
